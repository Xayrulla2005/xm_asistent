...
\restrict Z7itm2zniSbqATE4J8yPCfJ8Z5SMv7EmdRBNgQOvcOPOXiex0oRaWoUbuKy1FWx
...
--
-- Name: alipost; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA alipost;


--
-- Name: amirbekutarov86; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA amirbekutarov86;


--
-- Name: asdfgh; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA asdfgh;


--
-- Name: azamat-avto-extiyot-qismlari; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "azamat-avto-extiyot-qismlari";


--
-- Name: dilshod; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA dilshod;


--
-- Name: qwasdfv; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA qwasdfv;


--
-- Name: qwerth; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA qwerth;


--
-- Name: samsung; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: sdf; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: serf; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: sertyu; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA sertyu;


--
-- Name: sjeuue; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA sjeuue;


--
-- Name: test-dokon; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "test-dokon";


--
-- Name: test-wizardchi; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "test-wizardchi";


--
-- Name: tg-2105817330; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "tg-2105817330";


--
-- Name: tg-6954450770; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA "tg-6954450770";
...
--
-- Name: useruserss2000; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA useruserss2000;


--
-- Name: xayrulla; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA xayrulla;


--
-- Name: xayrullamatyakubov2005; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA xayrullamatyakubov2005;
...
\unrestrict Z7itm2zniSbqATE4J8yPCfJ8Z5SMv7EmdRBNgQOvcOPOXiex0oRaWoUbuKy1FWx
